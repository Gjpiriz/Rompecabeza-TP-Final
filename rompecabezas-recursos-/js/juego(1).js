...
function mostrarInstrucciones(instrucciones) {
    //COMPLETAR
    function mostrarInstrucciones(instrucciones) {
      function mostrarInstruccionEnLista(instruccion) {
          var listaInstrucciones = document.getElementById("lista-instrucciones");
          var elementoLista = document.createElement("li");
          elementoLista.textContent = instruccion;
          listaInstrucciones.appendChild(elementoLista);
      }
  ...
  // Llama a la función para mostrar las instrucciones
